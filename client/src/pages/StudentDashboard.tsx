...
import { Sidebar, studentNavItems } from "@/components/dashboard/Sidebar";
...
import { StudentAssignmentsPanel } from "@/components/dashboard/StudentAssignmentsPanel";
import { StudentSubmissionsPanel } from "@/components/dashboard/StudentSubmissionsPanel";
        ...
        <main className="mx-auto max-w-[1200px] px-8 py-6">
          <AnimatePresence mode="wait">
            ...
            {activeSection === "classrooms" && (
              ...
              >
                <div className="mb-6">
                  <h1 className="text-xl font-semibold tracking-tight">Joined Classrooms</h1>
                  <p className={`mt-1 text-sm ${isDark ? "text-zinc-500" : "text-zinc-500"}`}>
                    Classrooms you've joined and their materials.
                  </p>
                </div>
            ...
            {activeSection === "contests" && (
              ...
              >
                <div className="mb-6">
                  ...
                  <p className={`mt-1 text-sm ${isDark ? "text-zinc-500" : "text-zinc-500"}`}>
                    Participate in coding contests and competitions.
                  </p>
                </div>
                <EmptySection
                  icon={Trophy}
                  title="No contests available"
                  description="Active contests from your classrooms will appear here. Check back when your teacher creates one."
                />
              </motion.div>
            )}
            ...
            {activeSection === "submissions" && (
              ...
              >
                <div className="mb-6">
                  ...
                  <p className={`mt-1 text-sm ${isDark ? "text-zinc-500" : "text-zinc-500"}`}>
                    Track your assignment and contest submissions.
                  </p>
                </div>
