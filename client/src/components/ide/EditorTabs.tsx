        ...
        >
          {tabs.map((tab) => {
            ...
            return (
              <div
                key={tab.path}
                className={`group flex items-center gap-1.5 px-3 h-[35px] cursor-pointer border-r border-[#252526] min-w-0 max-w-[180px] transition-colors ${
                  isActive
              ...
              >
                ...
                {tab.isDirty && (
                  <Circle className="w-2 h-2 fill-current text-[#cccccc] shrink-0" />
                )}
                <button
        ...
        {activeFileTab ? (
          ...
          <div className="h-full flex items-center justify-center bg-[#1e1e1e]">
            <div className="text-center max-w-sm">
              <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-[#252526] flex items-center justify-center">
                <svg className="w-10 h-10 text-[#3c3c3c]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5" />
                </svg>
              </div>
              <p className="text-[15px] font-medium text-[#858585] mb-2">Nebula IDE</p>
              <div className="space-y-1.5 text-[12px] text-[#6a6a6a]">
                <p><kbd className="px-1.5 py-0.5 bg-[#252526] rounded text-[#858585] text-[11px]">Ctrl+S</kbd> Save file</p>
                <p><kbd className="px-1.5 py-0.5 bg-[#252526] rounded text-[#858585] text-[11px]">Ctrl+`</kbd> Toggle terminal</p>
              </div>
            </div>
          </div>
        )}
